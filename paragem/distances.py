...
def find_nearest(array, value):
    """ Finds index in array that is nearest to the given value
    ...
    Returns:
        index of array that the value is nearest to
    """
...
def get_solution_index(comm, sol_element_key):
    """Gets index of solution element

    Args:
        comm: community object
        sol_element_key: solution key

    Returns:
        index of solution referring to key
    """
...
class DistanceTimeseriesEuclidianDistance:
    ...
    def calculate_distance(self, community: Community):
        """ Calculates distance

        Euclidian distance calculated as the sum of the absolute difference
        between the experimental data and the simulation data from the closest
    ...
    def assess_particle(self, community: Community):
...
class DistanceTimeseriesEuclidianDistancePointWise:
    """ Pointwise euclidian distance between simulation and experiment
    ...
    def calculate_distance(self, community) -> np.ndarray:
        """ Calculates distance

        Vector of distances is produced. Each value is the absolute difference
        between the experimental data and the simulation data from the closest
        corresponding timepoint
...
class DistanceFoldChangeError:
    ...
    def calculate_distance(self, community):
        """ Calculate fold change error

        Calculates sum of absolute differences between fold change of simulation and the
        experiment with reference to the initial value.

        Warning: Assumes experimental data used is already a fold change
